 ...
 let Jokes = [`Where do pirates get their hooks? Secondhand stores.`,
...
`pomeranian dog on pool float dog wearing sunglasses, dog on vacation, floating in a swimming pool on a pizza shaped pool raft conceptual image for relaxation, labor day, memorial day, fourth of july, and summer funpinterest icon`,

`Jena Ardell is the best time on a clock, hands down.`,
...
`Wy can't a leopard hide? Because he's always spotted.`,
...
`girl friends hanging out togetherpinterest icon`,
`Nick David`,
...
`senior woman and adult daughter laughing on porchpinterest icon`,
...
`hy don’t eggs tell jokes? They’d crack each other up.`,

`n of the cows didn’t produce milk today. It was an udder failure.`,
...
`grandmother and grandson fooling around, using bananas as telephones, laughingpinterest icon`,
...
`Ho do you make a water bed bouncier? Add spring water.`,
